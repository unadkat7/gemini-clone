...
function Main() {
    ...
    const {onSent,recentPrompt,showResult,loading,resultData,input,setInput,newChat,theme,toggleTheme} = useContext(Context);
        ...
        {!showResult
            ...
            <div className="greet">
                ...
                <p>How can i help you today?</p>
                    ...
                    <div className="card" onClick={()=>onSent('Suggest beautiful places to see on an upcoming raod trip')}>
            ...
            <div className="main-bottom">
                ...
                <div className="search-box">
                    ...
                    <div>
                        ...
                        <img src={assets.pause_icon} onClick={()=>newChat()} />
